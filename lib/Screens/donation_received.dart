...
class _DonationReceivedState extends State<DonationReceived> {
  ...
  Future<void> _updateDonationHistory(
      String id, String name, String type, String url) async {
    ...
    return Scaffold(
      ...
      body: FutureBuilder<DocumentSnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          final message =
              "Danke für Ihre Spende von $amount€ an $name. Wenn Sie uns noch etwas mitteilen möchten, zögern Sie nicht, uns über das Kontaktformular zu benachrichtigen.";
...
class _ReceiptState extends State<Receipt> {
  ...
  Future<String?> _handlePdfUpload() async {
    if (kIsWeb) {
      ...
      final file = File(
          '${directory.path}/Quittung_${DateTime.now().millisecondsSinceEpoch}.pdf');
                ...
                onTap: () async {
                  try {
                    await shareToFacebook(
                        'https://serviceclub-app.de/#/Donations?eventId=$eventId');
                  } catch (e) {
