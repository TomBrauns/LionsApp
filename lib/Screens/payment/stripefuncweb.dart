...
Future<void> stripeOnPressWeb(amount, Id, context, baseUrl, Endpoint, sub,
    Idtype, eventName, customerId) async {
  ...
  List<String> CheckoutObject = await stripeWebCheckout(ProductObject[1],
      baseUrl, amount, Id, Endpoint, sub, Idtype, eventName, customerId);
...
Future<List<String>> stripeWebCheckout(priceId, baseUrl, amount, Id, Endpoint,
    sub, Idtype, eventName, customerId) async {
